        ...
        <div class="col-12 my-auto w-100">
          ...
          <div class="card mx-auto rounded-0 border border p-md-3 p-1 shadow" style="max-width:400px;">
            <div class="card-body">
              ...
              <p class="text-center text-primary mb-4">Admin Panel</p>
              <form id="admin-login-form">
                <label class="form-label text-muted mt-2" for="">Username:</label>
                <input type="password" name="username" class="form-control" autofocus required>

                <label class="form-label text-muted mt-2" for="">Password:</label>
                <input type="password" name="password" class="form-control" required>

                <div class="d-grid">
                  <button type="submit" id="admin-login-btn" class="btn btn-primary mt-3 rounded-0">Login</button>
                </div>
              </form>
            </div>
          </div>
